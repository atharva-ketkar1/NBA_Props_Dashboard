...
import { SimilarPlayerGame } from '../types';

interface SimilarPlayersProps {
   similarGames?: SimilarPlayerGame[];
}

export const SimilarPlayers: React.FC<SimilarPlayersProps> = ({ similarGames }) => {
   const data = similarGames || SIMILAR_GAMES;

   return (
      <div className="bg-black rounded-lg p-5 w-full flex flex-col h-full">
         <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex bg-bgCanvas rounded-lg p-1 border border-border shrink-0 ml-2">
         ...
         <div className="w-full overflow-x-auto custom-scrollbar pb-2">
            <div className="min-w-[600px]">
               <div className="grid grid-cols-[1fr_1.5fr_2fr_1fr_1fr_1fr] text-[10px] text-fgSubtle font-bold uppercase mb-3 px-2">
                  <div>Date</div>
                  <div>Team</div>
                  <div>Player</div>
               ...
               <div className="space-y-1">
                  {data.map((game, idx) => (
                     <div key={idx} className="grid grid-cols-[1fr_1.5fr_2fr_1fr_1fr_1fr] text-xs items-center py-2.5 px-2 hover:bg-bgCanvas rounded transition-colors border-b border-borderMedium/40 last:border-0">
         ...
         <div className="flex items-center justify-center gap-2 mt-auto pt-4 text-xs font-bold text-gray-400">
            <div className="w-6 h-6 bg-borderMedium rounded flex items-center justify-center text-blue-500 cursor-pointer hover:bg-gray-700">
